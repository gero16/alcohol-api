import type { ApiGuideDetail, ApiGuideSection, ApiGuideTab } from "./contracts";
...
type GuideNavGuide = Pick<ApiGuideDetail, "category"> & {
  tabs: Array<
    Pick<ApiGuideTab, "slug" | "label"> & {
      showInNav?: boolean | null;
      sections: Array<Pick<ApiGuideSection, "slug" | "title"> & { showInNav?: boolean | null }>;
    }
  >;
};
